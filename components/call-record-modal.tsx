...
export function CallRecordModal({
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-zinc-950/60 px-4 py-6">
      <div className="max-h-[90vh] w-full max-w-4xl overflow-hidden rounded-lg border border-zinc-200 bg-white shadow-2xl">
        <div className="flex items-start justify-between gap-4 border-b border-zinc-200 px-6 py-5">
          <div>
            <p className="text-xs uppercase tracking-[0.08em] text-zinc-500">Call Record</p>
            ...
            <div className="mt-2 flex flex-wrap items-center gap-2">
              ...
              <p className="text-sm text-zinc-600">{getTranscriptStatusLabel(transcriptStatus)}</p>
            </div>
          </div>
          <button
